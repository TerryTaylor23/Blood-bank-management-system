...
$query = "SELECT Blood_Type, Rh_Factor, Status, COUNT(*) as Quantity, hospital.Hospital_Name 
          FROM blood_bag 
...
echo "<h2>Current Stock Levels</h2>";
echo "<table class='table table-bordered table-striped mt-3'>";
echo "<thead class='thead-dark'><tr><th>Blood Type</th><th>Rh Factor</th><th>Quantity</th><th>Hospital</th><th>Status</th></tr></thead>";
echo "<tbody>";
